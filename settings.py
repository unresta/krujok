...
DEFAULTS: dict[str, int] = {
    ...
    "trial_views": config.TRIAL_VIEWS,
    "trial_push_minutes": config.TRIAL_PUSH_MINUTES,
...
TITLES: dict[str, str] = {
    ...
    "trial_views": "Бесплатных кружков до ОП",
    "trial_push_minutes": "Напомнить о них через, мин",
    ...
    "push_unaccepted": "Звать так и не начавших, 0/1",
