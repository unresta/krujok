...
DEFAULTS: dict[str, int] = {
    ...
    "push_hour_from": config.PUSH_HOUR_FROM,
    "push_hour_to": config.PUSH_HOUR_TO,
    "push_tz_offset": config.PUSH_TZ_OFFSET,
...
TITLES: dict[str, str] = {
    ...
    "push_hour_from": "Слать не раньше, ч",
    "push_hour_to": "Слать не позже, ч",
