...
# Long enough to need splitting when sent, and rarely changed, so they live
# here rather than in the panel's text editor: its edit screen cannot show a
# document this size in one piece, and a half-copied legal text is worse than
# none. Replace them here when the wording changes.
...
def doc_parts(name: str, limit: int = 3800) -> list[str]:
