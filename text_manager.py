...
EDITABLE: dict[str, Item] = {
    ...
    "PROFILE_STATUS_BOOST": Item(
        "Своя анкета: оплаченные показы",
        "Анкета автора",
        vars={"left": "сколько показов осталось"},
    ),
    "BOOST_SCREEN": Item(
        "Продвижение: экран покупки",
        "Анкета автора",
        vars=_COIN | {"example": "пример пакета", "coins": "баланс",
                      "left": "сколько показов осталось"},
    ),
    "BOOST_BOUGHT": Item(
        "Продвижение куплено",
        "Анкета автора",
        vars=_COIN | {"views": "сколько показов купили", "price": "сколько списано",
                      "left": "сколько показов всего"},
    ),
    "BOOST_POOR": Item(
